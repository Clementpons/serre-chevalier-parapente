...
interface OrderItem {
  ...
  stage?: any;
  bapteme?: any;
  stageBooking?: { shortCode?: string | null };
  baptemeBooking?: { shortCode?: string | null };
}
...
export const OrderConfirmationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Confirmation de votre réservation - Commande {orderNumber}
      </Preview>
      <Body style={main}>
        <Container style={container}>
                  ...
                  <div>
                    ...
                    {item.type === "GIFT_VOUCHER" ? (
                      ...
                      <>
                        ...
                        {(item.stageBooking?.shortCode ||
                          item.baptemeBooking?.shortCode) && (
                          <Text style={bookingRef}>
            ...
            <div style={paidBox}>
              <div style={flexBetween}>
                <div>
                  ...
                  <Text style={paidDate}>
                    Transaction effectuée le {formatDateTime(orderDate)}
                  </Text>
                </div>
            ...
            {remainingTotal > 0 && (
              <div style={futureBox}>
                ...
                <Text style={futureNote}>
                  Les soldes seront à régler sur place le jour de
                  l&apos;activité.
                </Text>

                {futurePayments.map((payment, index) => (
                  <div key={index} style={futurePayment}>
                    <Text style={futurePaymentName}>
                    ...
                    <div style={flexBetween}>
                      ...
                      <Text style={futurePaymentAmount}>
                        {payment.amount.toFixed(2)}€
                      </Text>
                    </div>
                    <Text style={futurePaymentNote}>
                      À régler <strong>sur place</strong> le jour de
                      l&apos;activité
                    </Text>
                  </div>
                ))}
          ...
          <Section style={section}>
            ...
            <Row>
              ...
              <Column>
                ...
                <Text style={contactLink}>clementpons5@gmail.com</Text>
              </Column>
            </Row>
          </Section>
          ...
          <Section style={footer}>
            ...
            <Text style={footerText}>
              © {new Date().getFullYear()} Serre Chevalier Parapente - Tous
              droits réservés
            </Text>
          </Section>
        </Container>
