                      ...
                      {item.type === "GIFT_VOUCHER" ? (
                        ...
                        <>
                          <Text style={itemSubtitle}>
                            Acheteur: {item.participantData.buyerName} (
                            {item.participantData.buyerEmail})
                          </Text>
                          <Text style={itemSubtitle}>
                        ...
                        <>
                          ...
                          {(item.type === "STAGE" ||
                            ...
                            <Text style={itemSubtitle}>
                              Reste à payer:{" "}
                              <strong>{item.remainingAmount || 0}€</strong>
                            </Text>
                          )}
                        </>
                      )}
          ...
          <Section style={section}>
            ...
            <div style={paidBox}>
              {promoCode && promoDiscountAmount > 0 && (
                <div style={{ marginBottom: "12px", padding: "8px 12px", backgroundColor: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: "6px" }}>
                  <Text style={{ ...paidLabel, color: "#166534", margin: "0 0 2px" }}>CODE PROMO APPLIQUÉ</Text>
                  <Text style={{ fontSize: "14px", fontWeight: "600", color: "#16a34a", margin: "0" }}>
                    {promoCode} — -{promoDiscountAmount.toFixed(2)}€
                  </Text>
                </div>
              )}
              ...
              {remainingTotal > 0 && (
                <div style={{ marginTop: "8px" }}>
                  <Text style={{ ...paidLabel, color: "#92400e" }}>
                    RESTE À PAYER SUR PLACE
                  </Text>
                  <Text style={{ ...paidAmount, color: "#b45309" }}>
